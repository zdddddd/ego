 ...
 */
function login() {
    return location.href = "http://sso.ego.com/page/login";
}
function regist() {
    return location.href = "http://sso.ego.com/page/register";
}
...
function search(a) {
    var b = "http://search.ego.com/search/query.html?q=" + encodeURIComponent(document.getElementById(a).value);
